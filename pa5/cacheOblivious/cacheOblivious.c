...
void recursiveMatTrans (
    ...
    if (n<=2) { // base case
        ...
        recursiveMatTrans(global_n, n>>1, A, offset_row_A+m, offset_col_A+m, B, offset_row_B+m, offset_col_B+m);
        recursiveMatTrans(global_n, n>>1, A, offset_row_A+m, offset_col_A, B, offset_row_B, offset_col_B+m);
        recursiveMatTrans(global_n, n>>1, A, offset_row_A, offset_col_A+m, B, offset_row_B+m, offset_col_B);
    }
}
